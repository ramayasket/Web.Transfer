...
// Type: Mono.Security.Protocol.Tls.RSASslSignatureDeformatter
...
namespace Mono.Security.Protocol.Tls
{
  ...
  internal class RSASslSignatureDeformatter : AsymmetricSignatureDeformatter
  {
    ...
    [CompilerGenerated]
    private static Dictionary<string, int> __f__switch_map15;
      ...
      if (key != null)
      {
        if (__f__switch_map15 == null)
          ...
          Dictionary<string, int> dictionary = new Dictionary<string, int>(1) {
                    ...
                    __f__switch_map15 = dictionary;
        }
        if (__f__switch_map15.TryGetValue(key, out int num) && (num == 0))
                {
